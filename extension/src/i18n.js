...
(function () {
  const STR = {
    en: {
      ...
      stMicPrompt: "Allow microphone access in the window that opened, then press Start again.",
    ...
    es: {
      ...
      stMicPrompt: "Permite el acceso al micrófono en la ventana que se abrió, luego presiona Iniciar de nuevo.",
    ...
    pt: {
      ...
      stMicPrompt: "Permita o acesso ao microfone na janela que abriu e pressione Iniciar novamente.",
