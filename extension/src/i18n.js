...
(function () {
  const STR = {
    en: {
      ...
      stMicPrompt: "Allow microphone access, then press Start again.",
    ...
    es: {
      ...
      stMicPrompt: "Permite el acceso al micrófono, luego presiona Iniciar de nuevo.",
    ...
    pt: {
      ...
      stMicPrompt: "Permita o acesso ao microfone e pressione Iniciar novamente.",
