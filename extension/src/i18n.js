...
(function () {
  const STR = {
    en: {
      ...
      stMicPrompt: "Allow the mic in the window that popped up, then press Start again.",
    ...
    es: {
      ...
      stMicPrompt: "Permite el micrófono en la ventana que apareció, luego presiona Iniciar de nuevo.",
    ...
    pt: {
      ...
      stMicPrompt: "Permita o microfone na janela que apareceu e pressione Iniciar novamente.",
